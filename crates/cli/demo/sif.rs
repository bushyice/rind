...
fn main() {
  ...
  TransportMessage::log(format!("demo:start pid={pid}"));
  TransportMessage::log(format!("demo:cgroup {cgroup}"));
  TransportMessage::log(format!("demo:ns mount={}", ns_link("mnt")));
  TransportMessage::log(format!("demo:ns uts={}", ns_link("uts")));
  TransportMessage::log(format!("demo:ns ipc={}", ns_link("ipc")));
  TransportMessage::log(format!("demo:ns net={}", ns_link("net")));
